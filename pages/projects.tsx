    ...
    <>
      <div>
        <Head>
          ...
          <link
            href="https://fonts.googleapis.com/css2?family=Work+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,400&display=swap"
            rel="stylesheet"
          />
        </Head>
        ...
        <div>
          <div className="pt-40 pb-10 xl:pb-30 md:pb-20 max-w-[600px] xl:max-w-[1200px] md:max-w-[800px] mx-auto">
            ...
            <h1 className="font-bold text-2xl xl:text-5xl md:text-3xl text-white leading-[40px] xl:leading-[65px] md:leading-[50px] max-w-[600px]">
              Lorem ipsum doler sit amet doler lipsum
            </h1>
          </div>
